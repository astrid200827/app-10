...
def main(page: ft.Page):
    ...
    btn24 = ElevatedButton(content=ft.Imagene(src="Cuarta generacion.png.png", width=img_width, height=img_height, border_radius=border_radius, semantics_label="Cuarta generacion"), on_click=play_cuartageneracion)
    ...
    def route_change(route):
                        ...
                        ft.Container(
                            ft.Column(
                                controls=[
                                    ...
                                    ft.ElevatedButton(
                                        'La historia de las compútadoras',
                                        on_click=lambda _: [StopAll(),page.go('/historia')]),
                                    ft.Image(
                                        src="Portada.png",
        ...
        # Vista de la historia de las computadoras
                        ...
                        ft.Container(
                            ft.Column(
                                controls=[
                                    ...
                                    ft.Row(
                                        alignment="center",
                                        controls=[btn21, btn22, btn23, btn24, btn25, btn26]
                                    )
                                ],
                                alignment=ft.MainAxisAlignment.START
                            ),
